...
public class th {
	...
	static {
		b = new int[] { -20319, -20317, -20304, -20295, -20292, -20283, -20265,
		...
		a = new String[] { "a", "ai", "an", "ang", "ao", "ba", "bai", "ban",
				...
				"ju", "juan", "jue", "jun", "ka", "kai", "kan", "kang", "kao",
				"ke", "ken", "keng", "kong", "kou", "ku", "kua", "kuai",
				"kuan", "kuang", "kui", "kun", "kuo", "la", "lai", "lan",
				"lang", "lao", "le", "lei", "leng", "li", "lia", "lian",
				"liang", "liao", "lie", "lin", "ling", "liu", "long", "lou",
				"lu", "lv", "luan", "lue", "lun", "luo", "ma", "mai", "man",
				...
				"nu", "nv", "nuan", "nue", "nuo", "o", "ou", "pa", "pai",
	...
	public String a(String string) {
		int n = this.c(string);
		if (n > 0 && n < 160) {
			return String.valueOf((char) ((char) n));
		}
		int n2 = -1 + b.length;
		do {
			String string2 = null;
	...
	public String b(String string) {
		...
		for (int i = 0; i < string.length(); ++i) {
			...
			if (string2.getBytes().length >= 2
					&& (string2 = this.a(string2)) == null) {
				string2 = "unknown";
			}
