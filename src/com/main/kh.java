...
public class kh implements BaseColumns {
	public static final Uri a = Uri
			.parse("content://com.lazyswipe/default_favorites");
	...
	static String a(Locale paramLocale, int paramInt) {
		...
		return " (language IS NULL  OR  (include=1 AND  ( (match_country=1 AND language="
				+ str1
				+ " AND "
				+ "country"
				+ "="
	...
	public static void a(SQLiteDatabase paramSQLiteDatabase) {
		paramSQLiteDatabase
				.execSQL("CREATE TABLE  IF NOT EXISTS default_favorites (_id INTEGER PRIMARY KEY, package TEXT NOT NULL, language TEXT , country TEXT , include INTEGER DEFAULT 1, match_country INTEGER DEFAULT 1, app_type INTEGER )");
		paramSQLiteDatabase
				.execSQL("CREATE INDEX index_default_favorites_package ON default_favorites (package)");
	...
	private static void a(SQLiteDatabase paramSQLiteDatabase,
		...
		paramSQLiteDatabase
				.execSQL("INSERT INTO default_favorites (package, app_type) VALUES  ('"
	...
	private static void a(SQLiteDatabase paramSQLiteDatabase,
		...
		paramSQLiteDatabase
				.execSQL("INSERT INTO default_favorites (package, include, language, match_country, app_type) VALUES  ('"
						+ paramString1
						+ "'"
						+ ", "
						+ vd.a
	...
	public static void b(SQLiteDatabase paramSQLiteDatabase) {
		try {
			paramSQLiteDatabase
					.execSQL("ALTER TABLE default_favorites ADD COLUMN app_type INTEGER ");
			c(paramSQLiteDatabase);
			return;
	...
	private static void b(SQLiteDatabase paramSQLiteDatabase,
			String paramString, int paramInt) {
		paramSQLiteDatabase
				.execSQL("INSERT INTO default_favorites (package, include, language, country, app_type) VALUES  ('"
						+ paramString
						+ "'"
						+ ", "
						+ vd.b
